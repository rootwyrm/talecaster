...
LABEL	com.rootwyrm.product="TaleCaster" \
		...
		com.rootwyrm.talecaster.provides="lazylibrarian" \
		com.rootwyrm.talecaster.depends="bittorrent nntp" \
		com.rootwyrm.talecaster.service="lazylibrarian" \
		com.rootwyrm.talecaster.ports_tcp="8171" \
