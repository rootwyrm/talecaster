...
export app_url="https://sonarr.tv"
export app_git_url="https://github.com/Sonarr/Sonarr.git"
export app_destdir="/opt/sonarr"

#export app_cmd="/usr/bin/python /opt/headphones/Headphones.py"
export app_svname="sonarr"
export app_psname="sonarr"

## XXX: Packages: 
## mono libmediainfo sqlite nodejs
